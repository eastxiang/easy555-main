...
public class LoginUserController extends BaseController<User, Long> {
	...
	public String updateInfo(@CurrentUser User user, @RequestParam("email") String email,
			@RequestParam("mobilePhoneNumber") String mobilePhoneNumber, Model model,
	...
	public String changePassword(@CurrentUser User user, @RequestParam(value = "oldPassword") String oldPassword,
			@RequestParam(value = "newPassword1") String newPassword1,
			@RequestParam(value = "newPassword2") String newPassword2, Model model,
			RedirectAttributes redirectAttributes) {
